...
uses
  ...
  Controls, Menus, ActnList, Clipbrd, uHistory, LCLTranslator;
...
procedure TformUtils.LocalizationSpecialControl;
begin
  radgSortOf.Items.Text        := Res_SortOfItems;
  radgSortDirection.Items.Text := Res_SortDirectionItems;

  chkbIgnoreCaseSp.Caption     := Res_IgnoreCase;
  chkbMultiLineSp.Caption      := Res_MultiLine;
  chkbNonGreedySp.Caption      := Res_NonGreedy;

  lablSearchRn.Caption         := Res_TextSearch;

  chkbIgnoreCaseRn.Caption     := Res_IgnoreCase;
  chkbMultiLineRn.Caption      := Res_MultiLine;
  chkbNonGreedyRn.Caption      := Res_NonGreedy;

  radgSearchInRn.Items.Text    := Res_SearchInItems;

  chkbAddPreNumRn.Caption      := chkbAddPreNumSp.Caption;
  ...
  actnDeleteText.Caption       := formMain.actnDeleteText.Caption;
  actnUndo.Caption             := formMain.actnUndo.Caption;
  actnRedo.Caption             := formMain.actnRedo.Caption;

  actnRename.Caption           := formMain.actnRename.Caption;
  actnAddToFront.Caption       := formMain.actnAddToFront.Caption;
  actnAddToBehind.Caption      := formMain.actnAddToBehind.Caption;
  actnAddToChildFirst.Caption  := formMain.actnAddToChildFirst.Caption;
  actnAddToChildLast.Caption   := formMain.actnAddToChildLast.Caption;
end;
...
begin
  ...
  FHistory.SetHistoryData(nil, True, memoScript.Text);
end;
