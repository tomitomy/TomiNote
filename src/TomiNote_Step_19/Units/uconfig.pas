...
begin
  ...
  LanguageCode             := Ini.ReadString ('Options', 'LanguageCode', '');
  ...
  LastScriptID             := Ini.ReadInteger('Utils', 'LastScriptID', 0);
  UseNameFilterSc          := Ini.ReadBool   ('Utils', 'UseNameFilterSc', False);
  NameFilterSc             := Ini.ReadString ('Utils', 'NameFilterSc', '');
...
begin
  ...
  Ini.WriteString ('Options', 'LanguageCode', '"' + LanguageCode + '"');
  ...
  Ini.WriteInteger('Utils', 'LastScriptID', LastScriptID);
  Ini.WriteBool   ('Utils', 'UseNameFilterSc', UseNameFilterSc);
  Ini.WriteString ('Utils', 'NameFilterSc', '"' + NameFilterSc + '"');
