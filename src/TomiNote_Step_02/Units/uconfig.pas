...
begin
  ...
  TreeBarPercent           := Ini.ReadInteger('Layout', 'TreeBarPercent', 25);
  InfoBarPercent           := Ini.ReadInteger('Layout', 'InfoBarPercent', 30);
  RecyBarPercent           := Ini.ReadInteger('Layout', 'RecyBarPercent', 30);
  ...
  BrightForeColor          := Ini.ReadInteger('Theme', 'BrightFontColor', $212121);
  BrightBackColor          := Ini.ReadInteger('Theme', 'BrightBackColor', $F7F7F7);

  DarkForeColor            := Ini.ReadInteger('Theme', 'DarkFontColor', $D3D7CF);
  DarkBackColor            := Ini.ReadInteger('Theme', 'DarkBackColor', $2E3436);
  ...
  TreeBarFontSize          := Ini.ReadInteger('Theme', 'TreeBarFontSize', 12);
  NoteBarFontSize          := Ini.ReadInteger('Theme', 'NoteBarFontSize', 12);
  InfoBarFontSize          := Ini.ReadInteger('Theme', 'InfoBarFontSize', 12);

  ExpandSignSize           := Ini.ReadInteger('Theme', 'ExpandSignSize', 9);
