...
procedure TformImport.LocalizationSpecialControl;
begin
  openDlg1.Title := Res_TitleOpenDlg;
  seldDlg1.Title := Res_TitleSelDirDlg;

  radgImportFrom.Items.Text := Res_ImportFromItems;
  radgImportTo.Items.Text   := Res_ImportToItems;
end;
